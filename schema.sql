...
CREATE TABLE SUBJECT (SID INT PRIMARY KEY AUTO_INCREMENT, SNAME VARCHAR(20));
...
CREATE TABLE SCORE (USN VARCHAR(10), SID INT, TIME_TAKEN TIME, SCORE INT, PRIMARY KEY(USN,SID), FOREIGN KEY (USN) REFERENCES USERS (USN), FOREIGN KEY (SID) REFERENCES SUBJECT (SID));
